...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var colorWheelButton: Button
  ...
  //  private lateinit var resultcolor: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        colorWheelButton = findViewById(R.id.color_wheel_button)
    ...
    //    colorwheel = findViewById(R.id.colorwheel)
     ...
     //   resultcolor = findViewById(R.id.resultcolor)
        ...
        val colorWheelButton: Button = findViewById (R.id.color_wheel_button)
        colorWheelButton.setOnClickListener{
        ...
        genColorButton.setOnClickListener { view: View ->
            ...
            if(spinner1.selectedItemPosition == 0){ // ALL COLORS OPTION SELECTED
                ...
                allColors()
                textView5.setBackgroundColor(selectedColor)
                textView5.setText("#"+Integer.toHexString(selectedColor))

                allColors()
                textView6.setBackgroundColor(selectedColor)
                textView6.setText("#"+Integer.toHexString(selectedColor))
                ...
                textView5.setText("else")
                textView6.setText("else")
